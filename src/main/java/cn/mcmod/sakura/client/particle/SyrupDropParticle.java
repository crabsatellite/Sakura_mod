...
public class SyrupDropParticle extends TextureSheetParticle {
    ...
    public SyrupDropParticle(ClientLevel world, double xIn, double yIn, double zIn, double motionXIn, double motionYIn,
            double motionZIn) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel world, double xIn, double yIn, double zIn,
            ...
            SyrupDropParticle particle = new SyrupDropParticle(world, xIn, yIn, zIn, motionXIn, motionYIn, motionZIn);
