...
public class MapleCauldronScreen extends AbstractContainerScreen<MapleCauldronContainer> {
    ...
    private static final ResourceLocation BACKGROUND_TEXTURE = ResourceLocation.fromNamespaceAndPath(SakuraMod.MODID, "textures/gui/maple_pot.png");
    ...
    protected void renderBg(GuiGraphics ms, float partialTicks, int mouseX, int mouseY) {
...

        {
            ...
            if (heightInd > 0) {
                FluidRenderHelper.renderFluidStack(ms, this.leftPos + 35, this.topPos + 78 - heightInd, 16, heightInd, fluidTank.getFluid());
            }
        }
    }
}
