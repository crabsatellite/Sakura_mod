...
public class SakuraFeatureRegistry {
    ...
    public static final DeferredRegister<Feature<?>> FEATURES = DeferredRegister.create(
            Registries.FEATURE, SakuraMod.MODID);

    public static final DeferredHolder<Feature<?>, Feature<NoneFeatureConfiguration>> HOT_SPRING_FEATURE = FEATURES.register(
    ...
    public static final DeferredHolder<TreeDecoratorType<?>, TreeDecoratorType<FallenLeavesDecorator>> FALLEN_LEAVES_DECORATOR = TREE_DECORATOR_TYPES.register(
            "fallen_leaves", () -> new TreeDecoratorType<>(FallenLeavesDecorator.CODEC));

    public static final DeferredHolder<TreeDecoratorType<?>, TreeDecoratorType<MapleSapLogDecorator>> MAPLE_SAP_LOG_DECORATOR = TREE_DECORATOR_TYPES.register(
            "maple_sap_log", () -> new TreeDecoratorType<>(MapleSapLogDecorator.CODEC));

    public static final DeferredHolder<TreeDecoratorType<?>, TreeDecoratorType<ChestnutBurrDecorator>> CHESTNUT_BURR_DECORATOR = TREE_DECORATOR_TYPES.register(
