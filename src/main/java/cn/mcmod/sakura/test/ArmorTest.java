...
public class ArmorTest {
    ...
    public static void kimono_pattern_variants_registered(GameTestHelper helper) {
        RegistryObject<Item>[] kimonoVariants = new RegistryObject[] {
        ...
        for (RegistryObject<Item> obj : kimonoVariants) {
